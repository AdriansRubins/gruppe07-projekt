<div id="datenschutz" class="overlay">
    <div class="popup">
        ...
        <p>Jeremias Sullivan, Greis<br>Datenschutzstraße, 41<br>97980,  Bad Mergentheim, Baden-Württemberg, Deutschland</p>
        E-Mail-Adresse:
        <p><a href="mailto:jer.greis.21@lehre.mosbach.dhbw.de">jer.greis.21@lehre.mosbach.dhbw.de</a></p>
        <br>
        ...
        <ul>
            <li><strong>Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b. DSGVO)</strong><p> - Die Verarbeitung ist für die Erfüllung eines Vertrags, dessen Vertragspartei die betroffene Person ist, oder zur Durchführung vorvertraglicher Maßnahmen erforderlich, die auf Anfrage der betroffenen Person erfolgen.</p></li>
            <li><strong>Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit. c. DSGVO)</strong><p> - Die Verarbeitung ist zur Erfüllung einer rechtlichen Verpflichtung erforderlich, der der Verantwortliche unterliegt.</p></li>
            <li><strong>Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f. DSGVO)</strong><p> - Die Verarbeitung ist zur Wahrung der berechtigten Interessen des Verantwortlichen oder eines Dritten erforderlich, sofern nicht die Interessen oder Grundrechte und Grundfreiheiten der betroffenen Person, die den Schutz personenbezogener Daten erfordern, überwiegen.</p></li>
        </ul>
